...
if ($shipment->status == "ERROR") { echo "<div class=\"col-md-12\"><div class=\"panel panel-danger\">
...
if ($testmode == true ) {
    ...
    Shippo::setCredentials("admin@concordexpress.uk", "Leicester09");
    
}

$retrieve_transaction = Shippo_Transaction::retrieve($shipment->transaction_obj);
?>
<div class="col-md-3">
    <div class="panel panel-info">
        <div class="panel-heading center">
        ...
        <div class="panel-body center">
            <h2>{{ $retrieve_transaction['tracking_status']['status'] }} <div class="pp_track_wrap" data-button-position="right" data-button-width="" data-button-height="default" data-button-color="#ffffff" data-button-background="#e51c23" data-button-carriers='[]' data-button-language="en" data-button-number="{{ $shipment->tracking_number }}" data-button-hide-number="1" data-domain="button.packpin.com"></div></h2>
...
<div class="col-md-3">
    <div class="panel panel-success">
        ...
        <div class="panel-body center">
            <h2>£{{ $shipment->shipment_cost_client }}</h2>
        </div>
    </div>
</div>
<div class="col-md-3">
